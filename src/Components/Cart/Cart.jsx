import { Badge, Box, Button, ButtonGroup, color, Divider, Flex, HStack, IconButton, Image, Spacer, Spinner, Stack, Text, VStack, Wrap } from '@chakra-ui/react';
...
const Cart = () => {
    ...
    if (cartData.length === 0) {
        ...
        return (
            ...
            <Wrap justify="center" style={{ backgroundColor:"#fff", color:"#000" }}>
    ...
    return (
        ...
        <VStack paddingTop="3rem" backgroundColor="#fff" color="#000" justify="center" >
            ...
            <Wrap padding={10} spacing={50} >
                ...
                <VStack spacing={5} >
                    ...
                    <HStack spacing={5} w="full" padding={3} bg="yellow.300" >  <Text fontWeight="bold" >Save extra ₹140 with TriBe</Text> <Spacer /> </HStack>
